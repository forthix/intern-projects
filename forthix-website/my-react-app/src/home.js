...
<div className="hero-head"><Navbar/></div>
      ...
      <div className="hero">
        ...
        <div className="video-container">
          <iframe class="iframe" src="https://www.youtube.com/embed/RhkUXejU7HI?si=1QwxRxE3Sy6P8uXj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
      </div>
      ...
      <div className="hero-body green-background">
        ...
        <p className="subtitle2">Every report is based on years of daily use by hundreds of Technical Program Managers in real organizations solving really tough problems. Each is the culmination of dozens of enhancements from execs, managers, and technical program managers. Leverage Jira to make more impactful decisions and drive action—give Forthix a try.</p>
          <div className="columns">
            ...
            {/*Edit the images below*/}

            <div className="column">
              <p className="title3">Dynamic History</p>
              <div className="pics">
                <img src="solutions-pic-1" alt="Dynamic History" width="100px" height="100px" />
              </div>
            ...
            <div className="column">
              ...
              <div className="pics">
                <img src="solutions-pic-2" alt="Org Rollups" width="100px" height="100px" />
              </div>
            ...
            <div className="column">
              ...
              <div className="pics">
                <img src="solutions-pic-3" alt="Flex Forms" width="100px" height="100px" />
              </div>
            ...
            <div className="column">
              ...
              <div className="pics">
                <img src="solutions-pic-4" alt="Custom Core" width="100px" height="100px" />
              </div>
      ...
      <div className="hero-body green-background">
        <div className="container">
          <p className="title2">FAQ</p>
          <p className="subtitle2">Frequently Asked Questions</p>
          <div className="faq-container">

          {/*Edit the questions and answers below*/}

          <div className="question"><FaqPreview question="Question 1" answer="Answer 1"/></div>
          <div className="question"><FaqPreview question="Question 2" answer="Answer 2"/></div>
          <div className="question"><FaqPreview question="Question 3" answer="Answer 3"/></div>
            <a href="/faq" className="more-faq-button">See more FAQs</a>
          </div>
        </div>
      </div>
      ...
      <div className="hero-body purple-background">
        <div className="container">
        <p className="title2 white-text">Reviews</p>
        <p className="subtitle2 white-text">Here are some testimonials from customers...</p>
          <div className="columns">

          {/*Edit the reviews and images below*/}

            <div className="column">
              <div className="pics">
                <img src="review-pic-1" alt="Company & Star Rating" width="100px" height="100px" />
              </div>
              <p className="subtitle3 white-text">This is a review. This is a review. This is a review. This is a review. This is a review. This is a review.</p>
            </div>
            <div className="column">
              <div className="pics">
                <img src="review-pic-1" alt="Company & Star Rating" width="100px" height="100px" />
